function [varargout] = emhist_custom_msn( data, t, w, p_exp,mu,s, varargin )
...
%     x = linspace(binctr(1),binctr(end),npts);
    ...
    ge=N*binwidth*pdfe;
    pdfb = u.*pdf('loglogistic',u,mu,s)*log(10);
    gb=N*binwidth*pdfb;
